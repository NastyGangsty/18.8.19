all_price = 0
ticket_quantity = int(input('Введите цифрами количество билетов: '))
...
if ticket_quantity > 3:
    ...
    print(f'Сумма к оплате со скидкой - {all_price} руб. (при регистрации более 3 участников предоставляется скидка 10%)')
else:
